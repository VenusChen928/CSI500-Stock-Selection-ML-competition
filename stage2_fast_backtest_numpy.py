...
def env() -> dict[str, str]:
    out = os.environ.copy()
    out["PYTHONPATH"] = f"{ROOT}:{ROOT / 'common' / 'legacy_scripts'}:{out.get('PYTHONPATH', '')}"
...
def main() -> int:
    ...
    parser.add_argument("--out-dir", default=str(ROOT / "submissions" / "stage2" / "backtests" / "fast_numpy"))
    parser.add_argument("--summary-out", default=str(ROOT / "submissions" / "stage2" / "final_report_materials" / "stage2_fast_numpy_summary.csv"))
